...
for x in temp_dataloger:    
    while x < x in temp_dataloger:
        x += x 
        continue
    if temperatura_max == None or x > temperatura_max:
        temperatura_max = x
print("La temperatura máxima es:", temperatura_max)
print("Control de cálculo:", max(temp_dataloger))
...
for x in temp_dataloger:
    while x > x in temp_dataloger:
        x += x
        continue
    if temperatura_min == None or x < temperatura_min:
        temperatura_min = x
print("La temperatura mínima es:", temperatura_min)
print("Control de cálculo:", min(temp_dataloger))
...
print("Control de la sumatoria:", sum(temp_dataloger))

temperatura_len = len(temp_dataloger)
print("Cantidad de temperaturas a analizar:", temperatura_len)

# Promedio
temperatura_promedio = temperatura_sumatoria / temperatura_len
print("El promedio de las temperaturas analizadas es:", temperatura_promedio)
...
for x in temp_dataloger:
        if temperatura_min >= 19 and temperatura_max <= 28:
            ...
            continue
        elif temperatura_min >= 11 and temperatura_max <= 19:
